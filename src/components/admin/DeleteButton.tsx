...
import { deleteRegistration, deleteUmkmRegistration, deleteWhooshRegistration } from '@/app/actions/admin'

export default function DeleteButton({ id, type = 'visitor' }: { id: string, type?: 'visitor' | 'umkm' | 'whoosh' }) {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true)
    const result = type === 'umkm'
      ? await deleteUmkmRegistration(id)
      : type === 'whoosh'
      ? await deleteWhooshRegistration(id)
