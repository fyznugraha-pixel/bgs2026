    ...
    <section className="py-[80px] w-full bg-bgs-yellow bg-sunburst border-b-8 border-black overflow-hidden">
      <div className="max-w-[1536px] mx-auto px-margin-mobile md:px-margin-desktop">
        <div className="mb-12 flex justify-center px-2 sm:px-0">
          <div className="bg-bgs-blue comic-border px-6 sm:px-8 py-3 sm:py-4 inline-block transform -rotate-1 comic-shadow-sm rounded-2xl max-w-full overflow-hidden">
            <h2 className="font-headline-md text-2xl min-[375px]:text-[26px] sm:text-4xl md:text-5xl font-black text-white uppercase italic text-outline-black-sm whitespace-nowrap text-ellipsis">Event Highlights</h2>
          </div>
        </div>
